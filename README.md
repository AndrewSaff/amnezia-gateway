...
- 🩺 Built-in healthcheck based on the latest tunnel handshake
...
| `MAX_HANDSHAKE_AGE` | `180` | healthcheck fails when the newest peer handshake is older than this many seconds |
